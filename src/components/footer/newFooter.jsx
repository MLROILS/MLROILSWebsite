...
import logodark from '../../assets/images/logo/mlr-logo-dark04.png';
        ...
        <footer className="footer">
                <div className="tf-container">
                    <div className="row" style={{display:'flex',justifyContent:'space-around'}}>
                        <div className="col-xl-4 col-lg-3 col-md-3" style={{display:'flex',alignItems:'center'}}>
                            <div className="widget widget-infor">
                                ...
                                <p className="content">Annavaram, 533406, East Godavari, Andhra Pradesh, India</p>
                                ...
                                {/* <p className="copy-right">Copyright © 2022 Themesflat. All Rights Reserved.</p> */}
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-4">
                            <div className="widget widget-subcribe">
                                <h6 className="widget-title">Venkat</h6>
                                <p className="content">To order our products contact us <br />
                                    +91 8106494942 <br />
                                    +91 8008586893</p>
